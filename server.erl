...
start() ->
    io:fwrite("\n\n Hola! This is the Erlang twitter version using websockets\n\n"),
...
await_connections(Listen, Table, Client_Socket_Mapping) ->
    ...
    ok = gen_tcp:send(Socket, "twitter users"),
                ...
                Type == "register" ->
                    ...
                    if
                        Output == [] ->
                            ...
                            ok = gen_tcp:send(Socket, "You are registered now. Please proceed to Login."), % RESPOND BACK - YES/NO
                            io:fwrite("The nickname has already been choosen. So please choose another.\n");
                        true ->
                            ok = gen_tcp:send(Socket, "nickname has already been taken! Try registering again with a different username"),
                            io:fwrite("Already choosen nickname!\n")
                    end,
